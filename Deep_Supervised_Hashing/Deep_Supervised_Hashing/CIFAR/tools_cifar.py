...
def pathmnist_dataset(config):
    ...
    pathmnist_dataset_root = '/dataset/pathmnist/'

    train_dataset = MyPathMNIST(root=pathmnist_dataset_root,
                              split='train',
                              transform=transform,
                              download=True)

    test_dataset = MyPathMNIST(root=pathmnist_dataset_root,
                             split='test',
                             transform=transform,
                             download=True)

    database_dataset = MyPathMNIST(root=pathmnist_dataset_root,
                                 split='val',
                                 transform=transform,
                                 download=True)
